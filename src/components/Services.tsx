    ...
    <div className="container mx-auto">
      <div className="text-center">
        ...
        <p className="section-subtitle">
          Complete documentation &amp; legal services under one roof
        </p>
      </div>
      ...
      <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {serviceCategories.map((cat, i) => (
          <div
            key={cat.title}
            className="group animate-fade-in-up rounded-2xl border border-border bg-card p-6 shadow-sm transition-shadow hover:shadow-lg"
